...
class ExpressServer {
    ...
    setupMiddleware() {
      ...
      this.app.get('/', (req, res) => res.sendFile(path.join(__dirname,'html','home.html')));
			...
			this.app.get('/insert', (req, res) => res.sendFile(path.join(__dirname,'html','insert.html')));
			this.app.get('/insert/:id', (req, res) => res.sendFile(path.join(__dirname,'html','insert.html')));
